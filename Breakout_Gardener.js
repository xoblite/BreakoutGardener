...
const IS31FL3731 = require('./modules/IS31FL3731.js');
...
{
    // Since the OLED display breakout is (for now at least) quite essential to the functionality of
    // this application, we will terminate if no supported display device was found on the I2C bus...
    console.log("%s -> ERROR -> No supported display was found on I2C bus 1! Terminating...", softwareName);
    I2C.Stop();
    return;
}
*/
...
if (dashboardEnabled) DASHBOARD.Start(dashboardPort, softwareVersion, outputLogs, showDebug);
...
function StopAll()
{
    ...
    // Let's stop the modules in the opposite order
    // of how we started them, just in case... ;)
